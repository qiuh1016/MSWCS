package com.zhd.mswcs.common.weidgt.xrefreshview;
...
public class CustomerFooter extends LinearLayout implements IFooterCallBack {
    ...
    private void initView(Context context) {
        mContext = context;
        ViewGroup moreView = (ViewGroup) LayoutInflater.from(mContext).inflate(R.layout.xrefreshview_customer_footer, this);
