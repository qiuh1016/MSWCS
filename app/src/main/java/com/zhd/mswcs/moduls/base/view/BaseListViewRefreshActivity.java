...
import com.zhd.mswcs.common.weidgt.xrefreshview.CustomHeader;
 ...
 */
public abstract class BaseListViewRefreshActivity<V extends MvpView,P extends MvpBasePresenter<V>> extends BaseMvpActivity<V,P>{
    ...
    public void initRefreshView(){
        ...
        refreshView.setCustomHeaderView(new CustomHeader(this,1000));
        //refreshView.setCustomHeaderView(new CustomGifHeader(this));
